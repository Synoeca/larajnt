<x-layout>
    <x-header>Todos Edit Page</x-header>
    <div class="max-w-2xl mx-auto p-4 bg-slate-200 dark:bg-slate-900 rounded-lg">
        <form method="POST" action="{{route('todos.update', $todo->id)}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="default-input" name="title" value="{{old('title', $todo->title)}}" class="@error('title') border-red-500 @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                @error('title')
